...
public class LinkedListTester {
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      System.out.println(String.format(" Push Time: %,25.6f", elapsedTime));
      System.out.println();
      ...
      System.out.println(String.format(" Append Time: %,25.6f", elapsedTime));
      System.out.println();
      ...
      System.out.print("Selection Sort ");
      startTime = System.nanoTime();
      answer = LinkedListSelectionSort.sort(theList2);
      endTime = System.nanoTime();
      elapsedTime = (double)(endTime - startTime)/NANO;
      System.out.println(String.format("%,22d %,21d %,25.6f", answer[0], answer[1], elapsedTime));
      if (verbose) {
