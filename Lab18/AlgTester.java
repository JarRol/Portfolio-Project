/****************************************************************************
* AlgTester.java -  A driver program to test some algorithms
*
* Name:
* Date:
*
...
public class AlgTester {
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      elapsedTime = (double)(System.nanoTime() - startTime)/1_000_000_000;
      ...
      startTime = System.nanoTime();
      answer = BubbleSort.sort(sortNums);
      elapsedTime = (double)(System.nanoTime() - startTime)/1_000_000_000;
      System.out.println(String.format("%,22d %,21d %,25.4f", answer[0], answer[1], elapsedTime));
      if (verbose) printArray(sortNums);
      ...
      startTime = System.nanoTime();
      answer = InsertionSort.sort(sortNums);
      elapsedTime = (double)(System.nanoTime() - startTime)/1_000_000_000;
      System.out.println(String.format("%,22d %,21d %,25.4f", answer[0], answer[1], elapsedTime));
      if (verbose) printArray(sortNums);
